...
public class RegisterFile {
    ...
    public static int STACK_POINTER_INIT = 0x7fffeffc;
    public static int REGISTER_NUMBER = 32;
    public static int GLOBAL_POINTER_INIT = 0x10008000;

    private ArrayList<Integer> registers = new ArrayList<>(REGISTER_NUMBER);
