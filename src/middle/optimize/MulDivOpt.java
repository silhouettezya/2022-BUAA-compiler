            ...
            while (!queue.isEmpty()) {
                ...
                while (Objects.nonNull(node) && node.hasNext()) {
                    ...
                    if (node instanceof BinaryOp
                        ...
                        Symbol quo = Symbol.temporary(Symbol.Type.ITEM);
                        Symbol part = Symbol.temporary(Symbol.Type.ITEM);
                        ...
                        if (op.equals(BinaryOp.Op.MUL)) {
                            ...
                            if (src1 instanceof Symbol && src2 instanceof Immediate) {
                                if (ADVANCED_DIV_OPT) {
                                    ...
                                    Symbol q = Symbol.temporary(Symbol.Type.ITEM);
                                    ...
                                    Symbol qSign = Symbol.temporary(Symbol.Type.ITEM);    // qSign = (q >> 31)
                                    ...
                                    Symbol qAnd = Symbol.temporary(Symbol.Type.ITEM);
                                    ...
                                    if (MathUtil.isLog2(((Immediate) src2).getValue())) {
                                        ...
                                        Immediate operand2 = new Immediate(MathUtil.log2(((Immediate) src2).getValue()));
                                        Symbol quotient = Symbol.temporary(Symbol.Type.ITEM);
                                        node.insertAfter(new BinaryOp(BinaryOp.Op.SRA, src1, operand2, quotient));
                                        node.remove();
                                        node = node.getNext().getNext();
                                        // 被除数为负，且不能整除
                                        Symbol negFlag = Symbol.temporary(Symbol.Type.ITEM);
                                        ...
                                        Symbol condLessZero = Symbol.temporary(Symbol.Type.ITEM);
                                        node.insertBefore(new BinaryOp(BinaryOp.Op.NE, src1, prod, condLessZero));
                                        Symbol cond = Symbol.temporary(Symbol.Type.ITEM);
                                        node.insertBefore(new BinaryOp(BinaryOp.Op.ANDL, negFlag, condLessZero, cond));
                                        Symbol fixQuotient = Symbol.temporary(Symbol.Type.ITEM);
